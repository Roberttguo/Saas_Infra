...
if __name__ == '__main__':
    ...
    print u.get_CSP_token("https://console-stg.cloud.vmware.com","96kZqY03yCH9wPxqaS7gfEk1gitWi3iCMg7iFoWAEoi-yYqXgPURAd56qaUjyWmI")